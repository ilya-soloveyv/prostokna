  ...
  methods: {
    get: function() {
      if (Number(this.iPartModelID)) {
        axios
          .post('/admin/part/getPartModelItem', {
    ...
    upload() {
      ...
      axios
        .post('/admin/part/uploadPartModel', form, {
          headers: {
          ...
          if (this.iPartModelID != iPartModelID)
            this.$router.push(
              '/part/' +
                ...
                this.iPartBrandID +
                '/' +
                response.data.partModel.iPartModelID
            );
