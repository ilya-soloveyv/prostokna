  ...
  methods: {
    ...
    upload: function (event) {
      ...
      axios
        ...
        .then((response) => {
          Vue.set(
            this.product.product_images[index],
            column,
    ...
    uploadColor: function (event) {
      ...
      axios
        .post('/admin/ProductUploadColor', form, {
          headers: {
            'Content-Type': 'multipart/form-data',
            extension: event.target.files[0].name.split('.').pop(),
          },
        ...
        .then((response) => {
          Vue.set(
            this.product.product_colors[index],
    ...
    useProductLink: function () {
      this.product.product_links.push({
        ...
        product: {
          ...
          bru: {
            sBrusTitle:
              this.product_links.bru !== null
                ? this.product_links.bru.sBrusTitle
                : false,
          },
        },
      });
