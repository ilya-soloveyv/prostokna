import '@scss/page-brand/page-brand.scss';
...
if ($('#page-brand').length) {
  ...
  $('.red-tooltip').tooltip({
    placement: 'left',
    template:
      '<div class="tooltip tooltip-page-brand" role="tooltip"><div class="arrow"></div><div class="tooltip-inner"></div></div>',
  });
  ...
  $('.gallery').slick({
    ...
    prevArrow:
      '<button type="button" class="slick-prev"><img src="/images/page-brand/arrow.svg"></button>',
    nextArrow:
      '<button type="button" class="slick-next"><img src="/images/page-brand/arrow.svg"></button>',
  });
