    ...
    vm = new Vue({
        ...
        currentCollections: function() {
          if (this.current_window !== null) {
            return this.materials[this.windows[this.current_window].material]
              .brands[this.windows[this.current_window].brand].models[
              this.windows[this.current_window].model
            ].glazings[this.windows[this.current_window].glazing].collection;
          }
          return null;
        }
      },
      methods: {
        ...
        insertOpening: function() {
          // окна
          var window_opening = this.currentCollections[
            this.windows[this.current_window].collection
          ].window_opening;
          ...
          // двери
          var door_opening = this.currentCollections[
            this.windows[this.current_window].collection
          ].door_opening;
        ...
        resetBrand: function(e) {
          ...
          if (
            !this.materials[value].brands ||
            !this.materials[value].brands.length
          ) {
            value = 0;
          }
        ...
        resetModel: function(e) {
          ...
          if (
            !this.materials[materialIndex].brands[value].models ||
            !this.materials[materialIndex].brands[value].models.length
          ) {
            value = 0;
          }
        ...
        calc: function() {
          ...
          var materials = this.materials[
            this.windows[this.current_window].material
          ];
          var brands =
            materials.brands &&
            materials.brands[this.windows[this.current_window].brand]
              ? materials.brands[this.windows[this.current_window].brand]
              : false;
          var models =
            brands.models &&
            brands.models[this.windows[this.current_window].model]
              ? brands.models[this.windows[this.current_window].model]
              : false;
          var glazings =
            models.glazings &&
            models.glazings[this.windows[this.current_window].glazing]
              ? models.glazings[this.windows[this.current_window].glazing]
              : false;
          var types =
            glazings.types &&
            glazings.types[this.windows[this.current_window].type]
              ? glazings.types[this.windows[this.current_window].type]
              : false;
          var price = types.price ? types.price : false;
          if (price) {
            var res = calculator(
              this.windows[this.current_window].x,
              this.windows[this.current_window].y,
              price
            );
