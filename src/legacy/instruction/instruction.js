import '@scss/instruction/instruction.scss';

if ($('.instruction').length) {
  // Tabs script

  $('.instruction__tabs .instruction__tabs_content').on('click', function () {
    $('.instruction__wrapp.active .num .num__item')
      .removeClass('none')
      .removeClass('active');
  ...
  $(document)
    .on('click', '.instruction__accor .acc__wrap', function () {
  ...
  function instructionPointOpenDesc(index) {
    ...
    $('.instruction__wrapp.active .acc__content')
      .not(':eq(' + index + ')')
      .slideUp();
    $('.instruction__wrapp.active .acc__wrap')
      .eq(index)
      .find('.acc__content')
      .slideToggle();
    ...
    if (
      ...
      $('.instruction__wrapp.active .num .num__item')
        ...
        .removeClass('active')
        .addClass('none');
      $('.instruction__wrapp.active .text .text__item')
        .eq(index)
        .addClass('active')
        .siblings()
        .removeClass('active');
