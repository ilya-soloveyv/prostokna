import Vue from 'vue';
import '@scss/modal-compare.scss';
...
const vueModalCompare = new Vue({
  ...
  methods: {
    ...
    makeCompare: function () {
      ...
      console.log(
        'selectedListProducts[0]',
        this.selectedListProducts[0].sProductTitle
      );
    ...
    hideSameValues: function () {
      ...
      if (this.markHideSameValue) {
        this.selectedListProducts.forEach((selectedProduct) => {
          ...
          heatTransferResistanceArr.push(
            selectedProduct.HeatTransferResistance
          );
...
$(document).on(
  ...
  function () {
    $(this)
      ...
      .siblings()
      .removeClass('active')
      .closest('div.tabs-content')
      .find('div.days-content')
      .removeClass('active')
      .eq($(this).index())
      .addClass('active');
